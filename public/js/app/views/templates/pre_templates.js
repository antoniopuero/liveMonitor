...
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="row-fluid tennis-hat event-hat">\r\n\t<div class="span1 event-num"><img src="img/sport_3.png">'+
((__t=( model.event_num ))==null?'':__t)+
'</div>\r\n\t<div class="span1 event-status">'+
((__t=( model.event.starttime ))==null?'':__t)+
'</div>\r\n\t<div class="span6 competitors text-center"> '+
((__t=( model.event.competitors.home.name ))==null?'':__t)+
' - '+
((__t=( model.event.competitors.away.name ))==null?'':__t)+
' </div>\r\n\t'+
((__t=( self.renderScore() ))==null?'':__t)+
'\r\n</div>\r\n';
}
return __p;
};
